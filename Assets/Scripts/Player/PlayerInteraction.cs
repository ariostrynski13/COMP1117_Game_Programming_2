...
{
    [Header("Interation Settings")]
    [SerializeField] private float interactRange = 1.5f; //How close I must be to the interactable object
    [SerializeField] private LayerMask interactableLayer; //Ensure that I'm interacting with interactable object

    //Function that will be called when the "Interract" action is triggered
